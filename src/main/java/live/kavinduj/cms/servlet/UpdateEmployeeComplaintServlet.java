...
@WebServlet("/updateEmployeeComplaint")
public class UpdateEmployeeComplaintServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (complaintDAO.updateComplaintDescription(complaintId, description)) {
